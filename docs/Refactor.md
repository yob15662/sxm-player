...
•	Move LoginIfNecessary(string), InitializeActivityTimer(), status checks into SxmSessionService.
2.	Channel state
...
•	Move RefreshAllCuts(string), GetNowPlaying(), SetNowPlayingFromSegment(SXMSegment, bool) into NowPlayingService.
